 // metatree
 let mtAddress = {
    metatreeAddr: "0x9f501C15D95d70590600AA7FF99539E0B78B0149",
  };  
   let mtAbi = {
  ...
  const topDataSync = async () => {
    ...
    document.getElementById("Price").innerHTML = (price/1e18);
  ...
  let MemberLogin = async () => {
    ...
    document.getElementById("Mseed").innerHTML= (myseed/1e18);  //원금
    document.getElementById("Mdepo").innerHTML= (mydepo/1e18);  //1회인출가능금액 
